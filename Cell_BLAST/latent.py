...
class CatGau(Latent):
    ...
    def fetch_latent(self, x: torch.Tensor) -> torch.Tensor:
        ...
        latent = gau + self.mat(cat)
        # import pickle
        # with open("/home/cnic02/wangyn/projects/Cell_BLAST/embs/gau_se.pkl", 'wb') as f:
        #     pickle.dump(gau, f)
        # with open("/home/cnic02/wangyn/projects/Cell_BLAST/cat_me.pkl", 'wb') as f:
        #     pickle.dump(cat, f)
        return gau, cat, latent
...
class SemiSupervisedCatGau(CatGau):
    ...
    def forward(self, x: torch.Tensor) -> typing.Tuple[torch.Tensor]:
        ...
        # import pickle
        # with open("/home/cnic02/wangyn/projects/Cell_BLAST/gau_semi.pkl", "wb") as f:
        #     pickle.dump(gau, f)
        # with open("/home/cnic02/wangyn/projects/Cell_BLAST/cat_semi.pkl", "wb") as f:
        #     pickle.dump(cat, f)
        latent = gau + self.mat(cat)
